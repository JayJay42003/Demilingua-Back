...
public class Usuario {
    ...
    @Column(name = "fecha_ultima_leccion")
    private Date fechaUltimaLeccion;
    ...
    public Date getFechaUltimaLeccion() { return fechaUltimaLeccion; }
    public void setFechaUltimaLeccion(Date fechaUltimaLeccion) { this.fechaUltimaLeccion = fechaUltimaLeccion; }
